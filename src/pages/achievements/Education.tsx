...
import { educationInitiatives, achievementYears } from '../../data/achievements';

export function Education() {
  const [activeYear, setActiveYear] = useState<number | 'all'>('all');
  const years = achievementYears.education;

  const filteredInitiatives = activeYear === 'all'
    ? educationInitiatives
    : educationInitiatives.filter(i => i.year === activeYear);
