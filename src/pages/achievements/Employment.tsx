...
import { employmentInitiatives, achievementYears } from '../../data/achievements';

export function Employment() {
  const [activeYear, setActiveYear] = useState<number | 'all'>('all');
  const years = achievementYears.employment;

  const filteredInitiatives = activeYear === 'all'
    ? employmentInitiatives
    : employmentInitiatives.filter(i => i.year === activeYear);
